...
CREATE TABLE `producto_ticket` (
  ...
  `idproducto_ticket` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idproducto_ticket`),
  KEY `idproducto_idx` (`idproducto`),
  KEY `idticket` (`idticket`),
  CONSTRAINT `idproducto` FOREIGN KEY (`idproducto`) REFERENCES `producto` (`idproducto`),
  CONSTRAINT `idticket` FOREIGN KEY (`idticket`) REFERENCES `ticket` (`idticket`)
...
INSERT INTO `producto_ticket` VALUES (1,4,1,38),(1,3,1,41),(1,1,1,42),(1,2,1,43),(1,4,1,44),(1,1,1,45);
